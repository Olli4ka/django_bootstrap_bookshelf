...
│   ├── static/
│   │   └── images/             
│   │       └── favicon.png  # Used for templates           
│   ├── templates/
│   │   ├── 404.html         # Bootstrap CDN
│   │   ├── 500.html         # Bootstrap CDN
│   │   ├── base.html        # Bootstrap CDN + navbar + blocks
│   │   ├── home.html        # Bootstrap CDN
...
```bash
git clone git@github.com:Olli4ka/django_bootstrap_bookshelf.git
...
## <span style="background: #3b2b4b;color:white;padding:4px 8px;border-radius:6px;">🥰</span> UX Enhancements
